...
server <- function(input, output) {
  ...
  df = data.frame(
    Language = c("Python", "R", "Stata", "SQL", "HTML", "CSS", "JavaScript", "DAX", "Pandas", "NumPy", "SciPy", "scikit-learn", "Keras", "TensorFlow", "Matplotlib", "Seaborn", "Regex", "requests", "Beautiful Soup", "Selenium", "json", "XGBoost", "CATBoost", "pickle", "joblib", "statsmodels", "NLTK", "Flask", "Shiny", "Stargazer", "ggplot2", "plotly", "tidy2", "dplyr", "PySpark", "Transformers"),
